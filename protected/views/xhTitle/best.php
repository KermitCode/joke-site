...
<div class="stat">
    <div class="stats">
        <span class="left"><a href="<?php echo $this->createUrl('site/index');?>">首页</a> -> <a href="<?php echo $this->createUrl('XhTitle/index');?>">文字笑话</a> -> <a href="#">爆笑笑话列表</a>
        </span>
...
<div class="main wid5">             
    <div class="mat wid5"><div class="left">爆笑<?php
