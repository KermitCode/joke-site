...
<div class="stat">
    <div class="stats">
        <span class="left"><a href="<?php echo $this->createUrl('site/index');?>">首页</a> -> <a href="#">文字笑话搜索</a></span>
...
<div class="right"><!--left float-->
    ...
    <div class="main wid5">             
        <div class="mat wid5"><div class="left">文字笑话搜索</DIV></div>
